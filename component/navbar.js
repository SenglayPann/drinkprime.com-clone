class Navbar extends HTMLElement {
    ...
    connectedCallback() {
        ...
        const customPathImgPath = this.getAttribute('customImgPath') || '..';
        ...
        this.innerHTML = `
                ...
                <div id="main-navbar" class="flex items-center justify-between px-[23px] des:px-0 tab:pr-[20px] border-b tab:border-none tab:order-2 w-full des:w-[calc(50%_+_55px)] des:justify-normal tab:py-[11px] tab:px-[7px] des:pr-[76px]">
                    ...
                    <div id="hamburger-button" class="right-icon cursor-pointer fill-white w-[26px] tab:hidden relative">
                        <svg id="hamburger-icon" class=" transition-none" role="presentation" viewBox="0 0 20 14"> <path class="${iconMustBlack}" d="M0 14v-1h20v1H0zm0-7.5h20v1H0v-1zM0 0h20v1H0V0z"></path></svg>
                        <div id="side-bar-closing-button" class="absolute top-0 w-full opacity-0 z-10">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><g><path class="${iconMustBlack}  fill-black" d="M52.83,50,96.41,6.41a2,2,0,0,0-2.82-2.82L50,47.17,6.41,3.59A2,2,0,0,0,3.59,6.41L47.17,50,3.59,93.59a2,2,0,1,0,2.82,2.82L50,52.83,93.59,96.41a2,2,0,0,0,2.82-2.82Z"></path></g></svg>
                        </div>
                        ...
                        <div id="side-bar" class="fixed flex flex-col overflow-y-scroll top-[50px] left-0 left-[calc(-100%)] w-[340px] h-[calc(100%_-_50px)] text-black bg-white cursor-default p-3">
                            <div class="grow-[1] pb-[142px]">
                                ...
                                <div class="side-bar-acc border-b-[.1em] border-b-slate-300">
                                    ...
                                    <div class=" list grid hidden grid-cols-1  text-stroke-sm text-[14px] tracking-wider">
                                        ...
                                        <div>
                                            <div class="p-[20px]">
                                                <a href="${customPath}/hydration-subpage.html">
                                                    <img src="${customPathImgPath}/assets/nav-drop-list/SB_Extended_Nav_Banner_Bundle_400x.png" alt="">
                                                </a>
                                        ...
                                        <div class="grid pb-10">
                                            <ul class="side-bar-ul px-[20px] leading-6">
                                                ...
                                                <li class=" pr-[40px] pb-[8px] pt-[8px] des:pb-0 w-[200px]">
                                                    <a href="${customPath}/athlete.html">TEAM+ ATHLETE</a>
                                                </li>
                                                <li class=" pr-[40px] pb-[8px] pt-[8px] des:pb-0 w-[200px]">
                                                    <a href="${customPath}/creator.html">CREATOR</a>
                                                </li>
                                                <li class=" pr-[40px] pb-[8px] pt-[8px] des:pb-0 w-[200px]">
                                                    <a href="${customPath}/artist.html">ARTIST</a>
                                                </li>
                                                <li class=" pr-[40px] pb-[8px] pt-[8px] des:pb-0 w-[200px]">
                                                    <a href="${customPath}/ambassador.html">AMBASSADOR</a>
                                                </li>
                                            </ul>
                                ...
                                <!-- where to buy -->
                                <div class="side-bar-acc border-b-[.1em] border-b-slate-300 mt-4">
                                    <a href="${customPath}/where-to-buy.html" class=" acc-section text-[13px] h-[53px] text-stroke-lg pb-[13px] tracking-widest leading-relaxed font-normalidadWide flex justify-between items-center">
                                        <div>WHERE TO BUY</div>
                                    </a>
                                </div>
                                <!-- verify your prime -->
                                <div class="side-bar-acc border-b-[.1em] border-b-slate-300 mt-4">
                                    <a href="${customPath}/verify-your-prime.html" class=" acc-section text-[13px] h-[53px] text-stroke-lg pb-[13px] tracking-widest leading-relaxed font-normalidadWide flex justify-between items-center">
                                ...
                                <div class="side-bar-ac mt-4 ">
                                    <a href="${customPath}/login.html" class=" acc-section text-stroke-sm text-[13px] h-[53px]  pb-[13px] tracking-widest leading-relaxed font-normalidad flex justify-between items-center">
                                        <div>LOGIN</div>
                                    </a>
                                </div>
                    ...
                    <figure id="drinkprime-logo" class="ml-10 tab:ml-0 tab:grow-0 des:grow-[1] tab:w-[115px] py-[5px] tab:py-0">
                        <a href="${customPathImgPath}/index.html" class="cursor-default"><img class=" cursor-pointer w-[90px] tab:w-[115px]" src="../assets/logo/Prime-Logo.png" alt="prime-logo"></a>
                    </figure>
                ...
                <div id="sec-navbar" class="grow-[1] hidden  font-normalidadWide tab:flex tab:order-3 des:order-1 tab:justify-center des:justify-normal des:border-none tab:border-b tab:w-full des:w-auto des:pl-[76px] gap-4 text-[12px] tracking-[.17em] text-stroke-semibold">
                    ...
                    <!-- about prime -->
                    <div class="sec-nav-ls py-[14px] des:py-[28px] relative">
                        <a class="sec-nav-ls  py-[14px] relative" href="${customPath}/about-prime.html">ABOUT PRIME</a>
                        <ul class="hidden-ls shadow-lg absolute bottom-[calc(-340%_-_33px)] des:bottom-[-210%] z-20  font-normalidad text-[14px] bg-white text-black text-nowrap opacity-0 py-[20px] text-stroke-sm tracking-wide">
                            ...
                            <li class="pl-[24px] pr-[40px] tab:pb-[8px] pt-[8px] des:pb-0 w-[200px]">
                                <a href="${customPath}/creator.html">Creators</a>
                            </li>
                            <li class="pl-[24px] pr-[40px] tab:pb-[8px] pt-[8px] des:pb-0 w-[200px]">
                                <a href="${customPath}/artist.html">Artists</a>
                            </li>
                            <li class="pl-[24px] pr-[40px] tab:pb-[8px] pt-[8px] des:pb-0 w-[200px]">
                                <a href="${customPath}/ambassador.html">Ambassador</a>
                            </li>
                    ...
                    <!-- where to buu -->
                    <div class="sec-nav-ls py-[14px] des:py-[28px] relative">
                        <a href="${customPath}/where-to-buy.html">WHERE TO BUY</a>
                        <div class="animate-border w-0 h-[2px] bg-black absolute bottom-[-2px] "></div>
                    </div>

                    <!-- verify your prime -->
                    <div class="sec-nav-ls py-[14px] des:py-[28px] relative">
                        <a href="${customPath}/verify-your-prime.html">VERIFY YOUR PRIME</a>
                        <div class="animate-border w-0 h-[2px] bg-black absolute bottom-[-2px] "></div>
                    </div>
                </div>
                ...
                <div id="search-bar" class="absolute -z-10 opacity-0 font-normalidadExteded w-full h-[74px] top-0 left-0">
                    <div id="inner-search-bar" class="flex items-center bg-white">
                        <input id="search-input" class="w-full h-[74px] grow-[1] text-[13px] text-stroke-md" type="text" placeholder="SEARCH...">
