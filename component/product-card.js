        ...
        this.innerHTML = `
            ...
            <div class=" w-full flex grow-[1] flex-col  items-center text-center  justify-between text-soft-gray1 font-normalidadExteded text-stroke-0.2">
                ...
                <div class="flex justify-end pb-[14px] mt-[7px] text-nowrap cursor-pointer">
                    <div class=" border border-solid border-black bg-black hover:bg-white hover:text-black text-white font-bold  px-[14px] tracking-wider max-[480px]:text-[9px] text-[11px] text-stroke-0.2  py-[8px] rounded font-normalidadExteded">ADD TO CART</div>
                </div>
            </div>
        `;
    }
